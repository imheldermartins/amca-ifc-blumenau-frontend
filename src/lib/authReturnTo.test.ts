...
describe('retorno ao convite após login',()=>{
 ...
 expect(readAuthReturnTo('/pt-br/access/page/id/requests/request')).toBe('/pt-br/access/page/id/requests/request')
  ...
  expect(readAuthReturnTo('/pt-br/workspace/workspace-id')).toBe('/pt-br/workspace/workspace-id')
  expect(readAuthReturnTo('/pt-br/my-chat?from=sidebar')).toBe('/pt-br/my-chat?from=sidebar')
 })
